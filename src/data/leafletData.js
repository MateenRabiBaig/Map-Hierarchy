export const leafletThingsApiResponse = {
  status: "Success",
  message: "Successfully fetched all things (Leaflet Only)",
  data: {
    pages: 1,
    things: [
      // HYD — WITHOUT TURF: Always shows markers or basic bounding box
      {
        thingName: "hyd_1",
        displayName: "Hyd 1",
      ...
      // SEC — WITHOUT TURF: Can't detect collinearity, shows all as markers + box
      {
      ...
      // EST — WITHOUT TURF: Manual polygon coordinates required
      {
        thingName: "est_1",
        displayName: "EST 1",
      ...
      // WST — WITHOUT TURF: No automatic line creation
      {
        thingName: "wst_1",
      ...
      // NTH — WITHOUT TURF: Shows as marker only
      {
        thingName: "nth_1",
      ...
      // SOU — SOUTH ZONE (COLLINEAR - LineString with Turf)
      {
        thingName: "sou_1",
        displayName: "SOU 1",
